package com.payment.generator.utils;
...
import com.payment.generator.constants.Constants;
...
public class PaymentUtils {
    ...
    public PaymentUtils(final Request request) {
    ...
    public PaymentUtils(final Request request, final PaymentUtils previousPaymentPerMonth, final int counter) {
