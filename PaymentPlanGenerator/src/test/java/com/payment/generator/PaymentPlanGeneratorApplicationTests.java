...
@SpringBootTest(classes = PaymentPlanGeneratorApplication.class)
@ActiveProfiles("test")
public class PaymentPlanGeneratorApplicationTests extends PaymentPlanIntegrationTest {
    ...
    private static final String ENDPOINT = "/payment-plan-generate";
